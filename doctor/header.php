...
<body class="app">    
  <header class="app-header fixed-top">                 
              ...
              <!--//dropdown-toggle-->
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                    <li><a class="dropdown-item" href="doctor.php" style="font-weight:600"><i class="fas fa-user"></i> Profile</a></li>
        ...
        <div id="sidepanel-drop" class="sidepanel-drop"></div>
          <div class="sidepanel-inner d-flex flex-column" style="background-image:-webkit-linear-gradient( 360deg,#f06292 0,#ec407a 100%);">
            ...
            <div class="app-branding">
              <a class="app-logo" href="index.html" style="text-decoration: none"><img class="logo-icon mr-2" src="https://www.pikpng.com/pngl/b/439-4397947_ems-logo-11-de-setembro-de-2018-263.png" alt="logo" style="margin-top: -8px;margin-left: -7px;width: 95px;height: 60px;"><span class="logo-text"style="color:white;">DOCTOR</span></a>
            </div><!--//app-branding-->  
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1" style="margin-top:20px">
              <ul class="app-menu list-unstyled accordion" id="menu-accordion" >
                <li class="nav-item has-submenu"style="background:rgba(0,0,0,.5);">
                  ...
                  <a class="nav-link submenu-toggle" href="doctor.php" data-toggle="collapse" data-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1" class="ba">
                    <span class="nav-icon">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
              ...
              <span class="nav-link-text" style="color: white;font-weight: 600;">Doctor Deatails</span>
    ...
    margin-top: 3px;color:white"></i>
          ...
          <span class="nav-link-text"style="color: white;font-weight: 600;">Patient Graph</span>
        </a><!--//nav-link-->
    </li><!--//nav-item-->
