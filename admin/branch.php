<?php include "header.php";?>
 <div class="app-wrapper">
	<div class="app-content pt-3 p-md-3 p-lg-4">
      ...
      <h1 style="margin-top: 11px;font-size: 24px;margin-bottom: 17px;">Branch</h1>
			...
			<div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert" style="border:1px solid white;">
				<div class="inner">
					<div class="app-card-body p-3 p-lg-4">
				      <div class="nav-item">
                <button class="btn"style="color:#ab47bc;background-color: #f3f1f1;border-bottom: 2px solid #e91e63;width: 144px;height: 44px;margin-top: -20px;margin-right: -40px;float: right;font-size:16px;font-weight: 600;"data-toggle="modal" data-target="#addblog">+ Add Branch</button>
              </div>
      ...
      <table id="example1" class="table table-bordered  ">
        ...
        <tbody>
          <tr>
            ...
            <td><?php echo $result['amount_patient']?></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header"style="background:#5f9bb9;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Add New Branch</h5><hr>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="background-color:#fafafa;">
        <form method="post" action="branch_insert.php" enctype="multipart/form-data">
                 <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="amount" placeholder="Enter employee age" class="form-control">
                          </div><br>
